...
print('Number of calls: ' + str(index))
print("Number of calls attempted from A: " + str(number_of_calls_A))
print("Number of calls attempted from B: " + str(number_of_calls_B))
print("Number of calls blocked: " + str(number_of_calls_blocked))
print("Proportion of calls blocked: " + str(number_of_calls_blocked/index))
